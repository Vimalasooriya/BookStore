...
public partial class Account_ViewStock : System.Web.UI.Page
{
...
TextBox txt5 = (TextBox)row.FindControl("TextBox5");
        ...
        int i11 = int.Parse(txt1.Text);
        int i21 = int.Parse(txt5.Text);
        int i31 = i11 * i21;
        ...
        if (ext.ToUpper() == ".PNG" || ext.ToUpper() == ".JPEG" || ext.ToUpper() == ".JPG")
        {
            ...
            string qry = ("update additemstock set fileupload = '" + path + "',Noofitems='" + txt1.Text + "',Actualprice='" + txt2.Text + "',Totalprice='" + i3.ToString() + "',date1='" + txt4.Text + "',Sellingcost='" + txt5.Text + "',TotalSelling='" + i31.ToString() + "',date2='" + txt6.Text + "',Status='Yes' where Id='" + lbl.Text + "'");
            int i = c1.inpudel(qry);
            if (i > 0)
            {
